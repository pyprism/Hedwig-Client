...
@useResult
$Res call({
 String id,@JsonKey(name: 'mailbox') String mailboxId,@JsonKey(name: 'thread') String? threadId, String direction, String status, String folder, String fromAddress, String? fromName, String? envelopeSender, String? envelopeRecipient, List<EmailAddress> toAddresses, List<EmailAddress> ccAddresses, List<EmailAddress> bccAddresses, String? replyTo, String subject, String? snippet, String? bodyText, String? bodyHtml, String? rawMimeUrl, bool isRead, bool isStarred, bool isImportant, bool hasAttachments, List<Attachment> attachments, Map<String, dynamic> rawHeaders, Map<String, dynamic> metadata, DateTime? receivedAt, DateTime? sentAt, DateTime? scheduledAt, DateTime? createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'mailbox')  String mailboxId, @JsonKey(name: 'thread')  String? threadId,  String direction,  String status,  String folder,  String fromAddress,  String? fromName,  String? envelopeSender,  String? envelopeRecipient,  List<EmailAddress> toAddresses,  List<EmailAddress> ccAddresses,  List<EmailAddress> bccAddresses,  String? replyTo,  String subject,  String? snippet,  String? bodyText,  String? bodyHtml,  String? rawMimeUrl,  bool isRead,  bool isStarred,  bool isImportant,  bool hasAttachments,  List<Attachment> attachments,  Map<String, dynamic> rawHeaders,  Map<String, dynamic> metadata,  DateTime? receivedAt,  DateTime? sentAt,  DateTime? scheduledAt,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MailMessage() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'mailbox')  String mailboxId, @JsonKey(name: 'thread')  String? threadId,  String direction,  String status,  String folder,  String fromAddress,  String? fromName,  String? envelopeSender,  String? envelopeRecipient,  List<EmailAddress> toAddresses,  List<EmailAddress> ccAddresses,  List<EmailAddress> bccAddresses,  String? replyTo,  String subject,  String? snippet,  String? bodyText,  String? bodyHtml,  String? rawMimeUrl,  bool isRead,  bool isStarred,  bool isImportant,  bool hasAttachments,  List<Attachment> attachments,  Map<String, dynamic> rawHeaders,  Map<String, dynamic> metadata,  DateTime? receivedAt,  DateTime? sentAt,  DateTime? scheduledAt,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _MailMessage():
return $default(_that.id,_that.mailboxId,_that.threadId,_that.direction,_that.status,_that.folder,_that.fromAddress,_that.fromName,_that.envelopeSender,_that.envelopeRecipient,_that.toAddresses,_that.ccAddresses,_that.bccAddresses,_that.replyTo,_that.subject,_that.snippet,_that.bodyText,_that.bodyHtml,_that.rawMimeUrl,_that.isRead,_that.isStarred,_that.isImportant,_that.hasAttachments,_that.attachments,_that.rawHeaders,_that.metadata,_that.receivedAt,_that.sentAt,_that.scheduledAt,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'mailbox')  String mailboxId, @JsonKey(name: 'thread')  String? threadId,  String direction,  String status,  String folder,  String fromAddress,  String? fromName,  String? envelopeSender,  String? envelopeRecipient,  List<EmailAddress> toAddresses,  List<EmailAddress> ccAddresses,  List<EmailAddress> bccAddresses,  String? replyTo,  String subject,  String? snippet,  String? bodyText,  String? bodyHtml,  String? rawMimeUrl,  bool isRead,  bool isStarred,  bool isImportant,  bool hasAttachments,  List<Attachment> attachments,  Map<String, dynamic> rawHeaders,  Map<String, dynamic> metadata,  DateTime? receivedAt,  DateTime? sentAt,  DateTime? scheduledAt,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _MailMessage() when $default != null:
return $default(_that.id,_that.mailboxId,_that.threadId,_that.direction,_that.status,_that.folder,_that.fromAddress,_that.fromName,_that.envelopeSender,_that.envelopeRecipient,_that.toAddresses,_that.ccAddresses,_that.bccAddresses,_that.replyTo,_that.subject,_that.snippet,_that.bodyText,_that.bodyHtml,_that.rawMimeUrl,_that.isRead,_that.isStarred,_that.isImportant,_that.hasAttachments,_that.attachments,_that.rawHeaders,_that.metadata,_that.receivedAt,_that.sentAt,_that.scheduledAt,_that.createdAt);case _:
  return null;
