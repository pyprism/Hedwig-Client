...
abstract class _$$ServerFailureImplCopyWith<$Res>
  ...
  @override
  @useResult
  $Res call({int statusCode, String message, Map<String, dynamic> fieldErrors});
}
...
class _$ServerFailureImpl implements ServerFailure {
  const _$ServerFailureImpl({
    ...
    final Map<String, dynamic> fieldErrors = const {},
  ...
  TResult when<TResult extends Object?>({
    ...
    return server(statusCode, message, fieldErrors);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return server?.call(statusCode, message, fieldErrors);
  }
